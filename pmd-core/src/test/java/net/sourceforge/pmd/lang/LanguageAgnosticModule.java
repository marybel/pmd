 ...
 */
public class LanguageAgnosticModule extends BaseLanguageModule {

    public static final String NAME = "LanguageAgnostic";
    public static final String TERSE_NAME = "any";

    public LanguageAgnosticModule() {
        super(NAME, null, TERSE_NAME, DummyRuleChainVisitor.class, "dummy");
        addVersion("*", new Handler(), true);
    }
